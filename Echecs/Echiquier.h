...
public:
    ...
    */
    ...
    Roi * getRoi(bool isWhite);

    bool roque(bool isWhite, bool isLeft);
    bool testerPromotion(int x, int y);
    void promotion(bool isWhite, int choix, int x, int y);
    bool testerPriseEnPassant(int x, int y);
    int estEchec(bool isWhite);
